...
{
    public partial class StatusMahasiswa : Form
    {
        private string stringConnection = "data source=LAPTOP-ENTD21T0\\ROQISB;" +
        "database=Disconnect_Environment;User ID=sa;Password=200502";
        ...
        private void StatusMahasiswa_Load(object sender, EventArgs e)
        {

        }
        private void refrestform()
        {
        ...
        private void FromDataStatusMahasiswa_FormClosed(object sender, FormClosedEventArgs e)
        {
